...
set(POLICY_NAME "apply_access_time")
...
set(CPACK_DEBIAN_PACKAGE_CONTROL_EXTRA "${CMAKE_SOURCE_DIR}/packaging/postinst_access;")
set(CPACK_RPM_POST_INSTALL_SCRIPT_FILE "${CMAKE_SOURCE_DIR}/packaging/postinst_access")

message(STATUS "JAK - CPACK_PACKAGE_NAME [${CPACK_PACKAGE_NAME}]")
message(STATUS "JAK - CPACK_PACKAGE_FILE_NAME [${CPACK_PACKAGE_FILE_NAME}]")
message(STATUS "JAK - IRODS_PACKAGE_COMPONENT_POLICY_NAME [${IRODS_PACKAGE_COMPONENT_POLICY_NAME}]")
message(STATUS "JAK - IRODS_PACKAGE_COMPONENT_POLICY_NAME_UPPERCASE [${IRODS_PACKAGE_COMPONENT_POLICY_NAME_UPPERCASE}]")
set(CPACK_DEBIAN_${IRODS_PACKAGE_COMPONENT_POLICY_NAME_UPPERCASE}_PACKAGE_NAME "${TARGET_NAME}")
message(STATUS "JAK - CPACK_DEBIAN_IRODS_PACKAGE_COMPONENT_POLICY_NAME_UPPERCASE_PACKAGE_NAME [${CPACK_DEBIAN_${IRODS_PACKAGE_COMPONENT_POLICY_NAME_UPPERCASE}_PACKAGE_NAME}]")
#set(CPACK_DEBIAN_${IRODS_PACKAGE_COMPONENT_POLICY_NAME_UPPERCASE}_PACKAGE_FILE_NAME "${TARGET_NAME}BANANAS")
#message(STATUS "JAK - CPACK_DEBIAN_IRODS_PACKAGE_COMPONENT_POLICY_NAME_UPPERCASE_PACKAGE_FILE_NAME [${CPACK_DEBIAN_${IRODS_PACKAGE_COMPONENT_POLICY_NAME_UPPERCASE}_PACKAGE_FILE_NAME}]")
